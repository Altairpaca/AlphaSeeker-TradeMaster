...
print("🚀 Starting the Upgraded XGBoost Pipeline...")
...
print("⚙️ Engineering Z-Scores and Interactions...")
...
# 2. FIXED Time Features (Divided by 240.0 to create actual waves)
...
# 4. Senior's Specific Interactions
...
# Using Date_ID split to completely prevent data leakage
...
print("\n" + "="*80)
print("Training XGBoost Models (Optimized for MAE)")
print("="*80)
...
print("\n" + "="*80)
print("🏆 True Kaggle Evaluation Summary")
print("="*80)
...
submission_xgb.to_csv('submission_xgb_upgraded.csv', index=False)
print(f"✅ Submission saved: submission_xgb_upgraded.csv")